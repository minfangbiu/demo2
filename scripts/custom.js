...
$(document).ready(function () {
	...
	$("#home").click(function() { 
		...
		$(this).parent().find('#about, #portfolio, #blog, #contact').removeClass('selected');
		$(this).parent().find(".home").show();
		$(this).parent().find(".about").hide();
		$(this).parent().find(".portfolio").hide();
		$(this).parent().find(".blog").hide();
		$(this).parent().find(".contact").hide();
	});
	$("#about").click(function() { 
		$(this).addClass('selected');
		$(this).parent().find('#home, #portfolio, #blog, #contact').removeClass('selected');
		$(this).parent().find(".home").hide();
		$(this).parent().find(".about").show();
		$(this).parent().find(".portfolio").hide();
		$(this).parent().find(".blog").hide();
		$(this).parent().find(".contact").hide();
	});
